 ...
 */
public class NfcOrderActivity extends AppCompatActivity implements NfcAdapter.CreateNdefMessageCallback {
    ...
    public NdefMessage createNdefMessage(NfcEvent event) {
        ...
        NdefMessage msg = new NdefMessage(
                new NdefRecord[] { NdefRecord.createMime(
                        "application/com.foodie.bjtu.foodie2",str.getBytes(Charset.forName("US-ASCII")))
                        /**
